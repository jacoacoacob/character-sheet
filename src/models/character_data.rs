...
pub struct CharacterData {
    ...
    pub death_save_fail: Option<isize>,
    pub death_save_success: Option<isize>,
    ...
    pub armor_class: Option<isize>,
    pub initiative: Option<isize>,
    pub speed: Option<isize>,
    pub hit_point_max: Option<isize>,
    pub hit_point_current: Option<isize>,
    pub hit_point_temp: Option<String>,
    pub hit_dice: Option<String>,
    pub hit_dice_current: Option<isize>,
    pub hit_dice_total: Option<isize>,
    pub cp: Option<isize>,
    pub sp: Option<isize>,
    pub ep: Option<isize>,
    pub gp: Option<isize>,
